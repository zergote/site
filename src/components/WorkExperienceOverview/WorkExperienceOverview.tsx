export default function WorkExperienceOverview() {
  return (
    <div className="containner ml-4 mr-4 pt-5 max-w-screen-sm md:max-w-screen-md sm:ml-6 md:ml-20 md:mr-20 lg:ml-32 lg:mr-32 xl:ml-72 xl:mr-72 2xl:ml-96 2xl:mr-96 lg:max-w-screen-md sm:mx-auto">
      <div>
        <h2 className="font-ainoHeadline text-2xl text-[#0000f0] mb-4" id="resume">Trabajo</h2>
      </div>

      <div className="flex text-start">
        <dl className="flex flex-col justify-between mb-5 text-[#323334]">
          <dt className="text-base font-aino"><span className="underline text-[#323334] decoration-[#323334] hover:decoration-[#0000f0] hover:text-[#0000f0]">NOVEDADES SULMIRA</span> Feb, 2020 | Nov, 2023</dt>
      ...
      <div className="flex text-start">
        ...
        <dl className="flex flex-col justify-between mb-5 text-[#323334]">
          ...
          <dd className="text-base font-aino">
            <p className="mb-3">Desarrollé una herramienta web para medir el comportamiento de la red de telefonía (2G, 3G y 4G) de la Corporación Digitel. <a href="/about#digitel" className="underline text-[#323334] decoration-[#323334] hover:decoration-[#0000f0] hover:text-[#0000f0]">Más detalles.</a></p>
          </dd>
        </dl>
      </div>
      ...
      <div className="flex text-start">
        ...
        <dl className="flex flex-col justify-between mb-5 text-[#323334]">
          ...
          <dd className="text-base font-aino">
            <p className="">Mi responsabilidad clave fue el mantenimiento de servidores, la configuración de redes y la gestión de dispositivos remotos.  <a href="/about#senifa" className="underline text-[#323334] decoration-[#323334] hover:decoration-[#0000f0] hover:text-[#0000f0]]">Más detalles.</a></p>
          </dd>
        </dl>
      </div>
    </div>
