export default function BottomNav() {
  return (
    <div className="bg-white text-black font-bold text-sm sticky bottom-0  sm:relative mt-5 rounded-t-lg font-mono pl-3 pr-3 sm:pl-16 sm:pr-16 border-t border-gray-600">
