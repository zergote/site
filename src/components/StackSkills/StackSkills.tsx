  ...
  return (
    <div className="bg-[#000087] text-white print:text-black print:bg-none">
      <div className="flex items-center text-center flex-col p-3 print:items-start print:p-0 print:text-start">
        ...
        <p className="font-ainoHeadline text-sm print:font-aino pt-1 px-2 print:px-0">JavaScript, TypeScript; Python; Node/React/Next.js; TailwindCSS; PostgreSQL; Serverless;Docker; Playwright; Jest; Git/GitFlow/GitHub</p>
      </div>
    </div>
  )
}