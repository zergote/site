      ...
      <div className="flex flex-col rounded-lg font-aino">
        ...
        <div>
          <span>
            ...
            <span> o</span> <a href="tel:+34679787002" className="font-aino underline">+34 679787002</a>.
          </span>
        </div>
      </div>
    </div >
